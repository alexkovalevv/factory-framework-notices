...
(function($) {
	...
	if( window.factory_notices_000_hide_notice ) {
		return;
	}
	...
	$(function() {
		...
		$(".factory-notice .factory-close").click(function() {
			...
			factory_notices_000_hide_notice(id, false);
			return false;
		});
	...
	window.factory_notices_000_hide_notice = function(id, never) {
		var item = $("#" + id).fadeOut(300, function() {
			...
			$.ajax({
				...
				data: {
					id: id,
					action: "factory_notices_000_hide",
